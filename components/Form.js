...
function Form() {
    ...
    const uploadPost = async (e) =>{
      ...
      const response = await fetch("/api/posts", {
        ...
        body: JSON.stringify({
          ...
          username: 'hasimyigit',
          email: 'hy@gmail.com',
          userImg: 'https://ui-avatars.com/api/?name=H+Y&background=random&color=fff',
    ...
    return (
        <form className="flex flex-col relative space-y-2 text-black/80 dark:text-white/75" onSubmit={uploadPost}>
          <textarea
            rows="4"
